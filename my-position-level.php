	...
	<tr>
             <td height="21" align="left" class="txt">
				<table width="100%"  border="0" align="center" cellpadding="0" cellspacing="0" class="title">
                    <tr>
                     <td width="73%" height="30" colspan="2" valign="middle" class="txt2 pad-left12"><img src="admin/images/admin.png" width="32" height="32" align="absmiddle" />&nbsp;My Position</td>
                    </tr>
					<?php if($commonObj->showError() != null) echo $commonObj->showError(); echo $commonObj->showMessage();	?>
					<tr id="treeViewLocation">
                     <td colspan="2" width="100%" height="820" >
...
var svg = d3.select("#treeViewLocation").append("svg")
...
d3.json("script/<?php echo $_SESSION['UID'];?>/file.json", function(error, flare) {
...
<script>
	$('#WalletArea').click(function(){ 
		$('#walletDisplayArea').slideToggle();
	});
	$('#ReleaseRequest').click(function(){ 
		$('#walletDisplayDetailArea').slideToggle();
	});
</script>
</body>
</html>
