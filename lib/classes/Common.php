...
class Common
{
	...
	function validate_user(){
		if($_SESSION['sess_uid']==''){
			$this->wtRedirect(SITE_URL."login.php?back=$_SERVER[REQUEST_URI]");
		}
	}
	...
	function showMessage(){
		if(isset($_SESSION["sess_success_msg"])) {
			$table = '<table align="center" id="errorbox">
			<tr><td  class="messageBox" id="errorboxcontent">'.$_SESSION["sess_success_msg"].'</td>
			</tr></table>';
			$_SESSION["sess_success_msg"] = null;
		} 
		else {
			$table = '<table align="center" id="errorbox" style="display:none">
			<tr><td  class="messageBox" id="errorboxcontent">&nbsp;</td>
			</tr></table>';
		}
		return $table;
	}
	...
	public function pushError($errMsg) {
		$_SESSION["sess_err_msg"] = $errMsg;
	}
	public function pushMessage($errMsg) {
		$_SESSION["sess_success_msg"] = $errMsg;
	}
	function sort_column($column) {
	$getString = $this->getQueryString(array("sort","column"));
