          ...
          <table width="328" border="0" align="center" cellpadding="10" cellspacing="0">
            <tr>
              <td><table width="328" border="0" cellspacing="0" cellpadding="0">
                  <tr>
                    <td height="56" colspan="3" class="txt3"><h3>Forget Password</h3></td>
                    </tr>
                  <tr>
                    <td width="70" class="blackbold">User Id</td>
                    <td width="20" align="left" class="blackbold">:</td>
                    <td><input name="user_id" type="text" class="input" id="user_id" /></td>
                  </tr>
              </table></td>
            </tr>
            ...
            <tr>
              <td><table width="328" border="0" cellspacing="0" cellpadding="0">
                <tr>
                  <td width="100" class="blackbold"><a href="forget-password.php">&nbsp;</a></td>
                  <td align="left" class="pad-right33">
