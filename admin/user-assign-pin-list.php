...
if(isset($_GET['uid'])){	
	...
	$TokenList = $UserObj->AssignedUsersPin($_GET);
	$pagingObj = new PagingClass2($obj->NumRows($UserObj->fetchAllAssignedUsersPin($_GET['uid'])),10);
		   ...
		   <form action="" method="get" enctype="multipart/form-data" name="frm" onsubmit="return validateFrm(this);">
			  <input type="hidden" name="submitForm" value="yes">
				...
				<table width="100%"  border="0" align="center" cellpadding="0" cellspacing="0" class="title">
                    <tr>
                     <td width="73%" height="30" valign="middle" class="txt2 pad-left12"><img src="images/admin.png" width="32" height="32" align="absmiddle" />&nbsp;<?php echo ucfirst($result->username);?>'s Assigned Pin </td>
